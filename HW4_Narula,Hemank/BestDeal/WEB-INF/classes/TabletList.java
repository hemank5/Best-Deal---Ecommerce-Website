...
public class TabletList extends HttpServlet {
	...
	/* Checks the Tablets type  */
		...
		All the tablets and tablet information are displayed in the Content Section
		...
		for (Map.Entry<String, Tablet> entry : hm.entrySet()) {
			...
			pw.print("<li id='item'><img src='images/tablet/"
			...
			pw.print("<li><form method='post' action='Cart'>" +
					...
					"<input type='hidden' name='zipcode' value='32801'>"+
			...
			pw.print("<li><form method='post' action='WriteReview'>"+"<input type='hidden' name='name' value='"+Tablet.getName()+"'>"+
					"<input type='hidden' name='type' value='tablets'>"+
					"<input type='hidden' name='maker' value='"+CategoryName+"'>"+
					"<input type='hidden' name='access' value=''>"+
					"<input type='hidden' name='state' value='Florida'>"+
			...
			pw.print("<li><form method='post' action='ViewReview'>"+"<input type='hidden' name='name' value='"+Tablet.getName()+"'>"+
					"<input type='hidden' name='type' value='tablets'>"+
					"<input type='hidden' name='maker' value='"+CategoryName+"'>"+
					"<input type='hidden' name='access' value=''>"+
					"<input type='hidden' name='state' value='Florida'>"+
