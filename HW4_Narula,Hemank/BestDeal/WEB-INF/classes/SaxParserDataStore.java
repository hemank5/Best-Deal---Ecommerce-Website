...
public class SaxParserDataStore extends DefaultHandler {
    ...
    String smartphoneXmlFileName;
	HashMap<String,String> televisionHashMap;
    String elementValueRead;
	String currentElement="";
    public SaxParserDataStore()
	{
	}
	public SaxParserDataStore(String smartphoneXmlFileName) {
    this.smartphoneXmlFileName = smartphoneXmlFileName;
	...
	televisionHashMap=new HashMap<String,String>();
	parseDocument();
    }
   ...
   //parse the xml using sax parser to get the data
    private void parseDocument() 
	{
	    ...
	    parser.parse(smartphoneXmlFileName, this);
...
////////////////////////////////////////////////////////////
    ...
    public void startElement(String str1, String str2, String elementName, Attributes attributes) throws SAXException {
        ...
        if (elementName.equals("television") &&  !currentElement.equals("smartphone"))
		{
	...
	// when xml end element is parsed store the data into respective hashmap for smartphone,tablet etc respectively
    @Override
    public void endElement(String str1, String str2, String element) throws SAXException {
        ...
        if (element.equals("television") && currentElement.equals("television")) {
        	televisions.put(television.getId(),television);       
			return; 
        }
		if (element.equals("television") && currentElement.equals("smartphone")) 
		{
			televisionHashMap.put(elementValueRead,elementValueRead);
		}
      	if (element.equalsIgnoreCase("televisions") && currentElement.equals("smartphone")) {
      		smartphone.setAccessories(televisionHashMap);
      		televisionHashMap=new HashMap<String,String>();
			return;
		}
