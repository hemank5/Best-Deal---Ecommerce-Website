...
public class Utilities extends HttpServlet{
	...
	public void storeReview(String productName, String zipcode,String productType, String reviewRating, 
			String reviewDate, String reviewText, String state,String city, String age, String occupation, 
			String maker,String gender,String rebate,String retailername,String onsale) {
		...
		System.out.println("Inside utilities zipcode: "+zipcode);
		ArrayList<Review> listReview = reviews.get(productName);
		Review review = new Review(productName,productType,username(),zipcode,reviewDate,reviewText,reviewRating,state,city,age,occupation,maker,gender,rebate,retailername,onsale);
		listReview.add(review);
		try
		{
		MongoDBDataStoreUtilities.insertReview(productName,username(),zipcode,productType,reviewRating,
				reviewDate,reviewText,state,city,age,occupation,maker,gender,rebate,retailername,
				onsale);
		}
		catch(Exception e)
		{ 
	...
	public void storeProduct(String name,String type,String maker, String acc){
		...
		if(type.equals("accessories")){	
			Television television = SaxParserDataStore.televisions.get(name); 
	...
	/* getSmartphones Functions returns the Hashmap with all smartphones in the store.*/
	...
	/* getLaptop Functions returns the  Hashmap with all Laptop in the store.*/
	...
	/* getProducts Functions returns the Arraylist of laptop in the store.*/
