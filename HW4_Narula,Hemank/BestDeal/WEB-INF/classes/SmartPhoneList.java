...
public class SmartPhoneList extends HttpServlet {
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7931760120077956791L;

	/*
	 * Console Page Displays all the Consoles and their Information in Game
	 * Speed
	 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		 ...
		 * 
		 * All the Smartphone and Smartphone information are displayed in the
		 * Content Section
		 * 
		...
		for (Map.Entry<String, SmartPhone> entry : hm.entrySet()) {
			...
			pw.print("<li><form method='post' action='Cart'>" + "<input type='hidden' name='name' value='"
					+ smartphone.getName() + "'>" + "<input type='hidden' name='type' value='smartphones'>"
					...
					+ "<input type='hidden' name='rebate' value='10%'>" + "<input type='hidden' name='access' value=''>"
